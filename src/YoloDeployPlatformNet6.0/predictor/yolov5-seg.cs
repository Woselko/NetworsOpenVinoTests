...
namespace YoloDeployPlatform.predictor
{
    public class YOLOv5Seg : YOLO
    {
        ...
        {
            Mat detect_data = Mat.FromPixelData(this.m_output_sizes[0][1], this.m_output_sizes[0][2], MatType.CV_32FC1, results[0]);
            Mat proto_data = Mat.FromPixelData(this.m_output_sizes[1][1], this.m_output_sizes[1][2], MatType.CV_32F, results[1]);
